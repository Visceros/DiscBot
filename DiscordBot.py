...
!poll <кол-во опций> <длительность в минутах> - возможность сделать из сообщения опрос. Команда пишется,
используя функцию "ответить" на сообщение из которого хотите сделать опрос.
